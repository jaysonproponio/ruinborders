...
// Mark announcements as seen in DB
try {
    $stmt = $db->prepare("UPDATE users SET seen_announcements_at = CURRENT_TIMESTAMP WHERE id = :id");
...
$has_new_announcements = false; // Visiting this page clears it
...
<body>
    <?php $current_user_page = 'announcements'; ?>
                ...
                <?php foreach ($announcements as $announcement): ?>
                    <div class="announcement-item">
                        ...
                        <div class="announcement-meta">
                            <div class="announcement-author">By <?php echo htmlspecialchars($announcement['admin_name']); ?></div>
                            <div class="announcement-date"><?php echo date('M d, Y g:i A', strtotime($announcement['created_at'])); ?></div>
                        </div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
